        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6" style="float: left">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="LastName">Meat</label>
                        <div class="controls">
                            <select class="input-xlarge element" placeholder="Your Name">
                                <option>1 potion 200/=</option>
                                <option>2 potion 300/=</option>
                     ...
                     <div class="control-group">
                        <label class="control-label" for="fistName">Tomato</label>
                        <div class="controls">
                            <select class=" input-xlarge element" placeholder="Your Name">
                                <option>1 potion 200/=</option>
                                <option>2 potion 300/=</option>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="LastName">Union</label>
                        <div class="controls">
                            <select class=" input-xlarge element" placeholder="Your Name">
                                <option>1 potion 200/=</option>
                                <option>2 potion 300/=</option>
